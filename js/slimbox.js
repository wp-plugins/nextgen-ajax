...
(function() {
	...
	*/
	...
	window.addEvent("domready", function() {
		...
		fx = {
			overlay: new Fx.Tween(overlay, {property: "opacity", duration: 100}).set(0),
			image: new Fx.Tween(image, {property: "opacity", duration: 100, onComplete: nextEffect}),
			bottom: new Fx.Tween(bottom, {property: "margin-top", duration: 100})
		};
	});
...
window.addEvent("domready", slimbox_scanpage);